...
namespace GamePollApp.Services
{
    public class SteamAPIService
    {
        ...
        public async Task<SteamGetOwnedGames_ResponseJson> GetOwnedGamesAsync(string steam_id, string[] filterArray = null, string include_appinfo = "1", string include_free = "0")
        {
